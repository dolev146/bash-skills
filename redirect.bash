...
# ls -l testdir throw error


# ls -l testdir 2> ls-err

# ls -l testdir > ls_out 2>&1  # Redirect stdout to ls_out and stderr to wherever stdout is because of the ampersand 
# 1>err
# 2>&1 
# 1>yakov
...
uniq -c # count the number of times each word appears in the file
unic -d # shows only duplicate
unic -u # shows only unique
...
# sort fruit.txt | uniq -c | wc | grep 3 # daniel example
